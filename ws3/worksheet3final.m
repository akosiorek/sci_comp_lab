...
%Worksheet 3 Submission (23.11.2014)
...
function [] = worksheet3()
     ...
     solvers = {@FullMatrixSolver, @SparseMatrixSolver,@GaussSeidelSolver}; %Arrays of solver functions and names
    ...
    fprintf('error e-03\t'); format short; disp(10^3.*errors(end,:));
...
function [T, runTime, storageReq] = GaussSeidelSolver(A, b, Nx, Ny)
