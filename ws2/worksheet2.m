...
function worksheet2()
    ...
    names = {'Explicit Euler method (q = 1)', 'Method of Heun (q = 2)', 'Implicit Euler (q = 1)', 'Adams-Moulton Method (q = 2)', 'Adams-Moulton Linerization 1 (q = 1)', 'Adams-Moulton Linerization 2 (q = 1)'};  % Method names
...
function output = AdamsMoulton(fun_dot, f0, min, max, delta, g, gd, e)   % Adams - Moulton Solver
...
function output = AdamsMoultonL1(~, f0, min, max, delta, ~, ~, ~)   % Adams - Moulton Linerization 1
...
function output = AdamsMoultonL2(~, f0, min, max, delta, ~, ~, ~)   % Adams - Moulton Linerization 2
...
function x = NR_solver(g, gd, x0, e, delta) % Newton-Rhapson Solver
